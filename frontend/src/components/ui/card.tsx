...
export const CardHeader: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div className={`flex flex-col space-y-1.5 p-5 border-b border-slate-100 ${className}`} {...props}>
    {children}
  </div>
);
...
export const CardFooter: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div className={`flex items-center p-5 pt-0 border-t border-slate-100 mt-4 ${className}`} {...props}>
    {children}
  </div>
);
